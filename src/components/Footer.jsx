...
const Footer = () => {
  return (
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-6">
              <a
                href="https://www.facebook.com/profile.php?id=100087892990128"
                target="_blank"
                rel="noreferrer"
                aria-label="Follow MCN on Facebook"
                className="flex items-center gap-2 bg-blue-600 text-white text-xs font-semibold px-4 py-2 rounded-full hover:opacity-90 hover:scale-105 transition-all duration-200"
              >
                <svg
    ...
    -2.03-.967-.273-.099-.471-.148-.67.15-.197.297
    -.767.966-.94 1.164-.173.199-.347.223-.644.075
    -.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48
    -1.761-1.653-2.059-.173-.297-.018-.458.13-.606
    .134-.133.298-.347.446-.52.149-.174.198-.298
    .298-.497.099-.198.05-.371-.025-.52-.075-.149
    -.669-1.612-.916-2.207-.242-.579-.487-.5-.669
    -.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074
    -.792.372-.272.297-1.04 1.016-1.04 2.479 0 
    1.462 1.065 2.875 1.213 3.074.149.198 2.096 
    3.2 5.077 4.487.709.306 1.262.489 1.694.625
    .712.227 1.36.195 1.871.118.571-.085 1.758
    -.719 2.006-1.413.248-.694.248-1.289.173-1.413
    -.074-.124-.272-.198-.57-.347z"/>
                  <path d="M12 0C5.373 0 0 5.373 0 12c0 2.117
    .549 4.107 1.508 5.84L.057 23.998l6.305-1.657
    A11.954 11.954 0 0012 24c6.627 0 12-5.373 
    12-12S18.627 0 12 0zm0 21.818a9.793 9.793 0 
    01-5.017-1.381l-.36-.214-3.737.983.999-3.648
    -.235-.374A9.794 9.794 0 012.182 12C2.182 6.57 
    6.57 2.182 12 2.182S21.818 6.57 21.818 12 
              ...
              <div className="flex items-center gap-2 mt-2">
                <svg xmlns="http://www.w3.org/2000/svg" 
                  ...
                  <path strokeLinecap="round" strokeLinejoin="round" 
                    ...
                    2 0 01-2 2h-1C9.716 21 3 14.284 3 8V5z"/>
                </svg>
